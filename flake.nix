{
  ...
  outputs =
    ...
    let
      ...
      list-flake-inputs = pkgs.writeShellApplication {
        name = "list-flake-inputs";
        runtimeInputs = [ myCrate ];
        text = builtins.readFile ./scripts/list-flake-inputs;
      };

      update-flake-input = pkgs.writeShellApplication {
        name = "update-flake-input";
        runtimeInputs = [ myCrate ];
        text = builtins.readFile ./scripts/update-flake-input;
      };

      filter-flake-inputs = pkgs.writeShellApplication {
        name = "filter-flake-inputs";
        runtimeInputs = [ myCrate pkgs.fzf ];
        text = builtins.readFile ./scripts/filter-flake-inputs;
      };
    ...
    in
    {
      ...
      packages.default = pkgs.symlinkJoin {
        name = "flake-input-tools";
        paths = [ filter-flake-inputs list-flake-inputs update-flake-input ];
      };
